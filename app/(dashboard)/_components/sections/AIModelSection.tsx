...
const models = [
  {
    ...
    icon: (
      <svg width="32" height="32" viewBox="0 0 24 24" fill="none">
        ...
        <path d="M12 6v12M6 12h12" stroke="#10a37f" strokeWidth="1.5" strokeLinecap="round" />
      </svg>
    ),
  },
  {
  ...
  },
  {
    ...
    icon: (
      <svg width="32" height="32" viewBox="0 0 24 24" fill="none">
        <path d="M12 2a10 10 0 1 0 10 10A10 10 0 0 0 12 2zm0 18a8 8 0 1 1 8-8 8 8 0 0 1-8 8z" fill="#4285f4" />
        ...
        {models.map((m) => (
          <div
            ...
            onMouseEnter={(e) => {
              ...
              e.currentTarget.style.boxShadow = `0 8px 32px ${m.color}15`;
            }}
            onMouseLeave={(e) => {
          ...
          >
            ...
            <h3 style={{ color: "#ffffff", fontSize: "18px", fontWeight: 600, margin: "0 0 10px" }}>
              {m.name}
            </h3>
