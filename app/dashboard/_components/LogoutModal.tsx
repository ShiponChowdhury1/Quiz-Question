  ...
  return (
    ...
    >
      ...
      >
        ...
        <p style={{ color: "rgba(255,255,255,0.45)", fontSize: "14px", margin: 0 }}>Are you sure you want to logout?</p>
        <div style={{ display: "flex", gap: "16px", width: "100%", marginTop: "8px" }}>
          <button onClick={onClose} style={{ flex: 1, padding: "13px", borderRadius: "10px", background: "#4F46E5", border: "none", color: "#ffffff", fontSize: "14px", fontWeight: 600, cursor: "pointer" }}>No, Cancel</button>
          <button onClick={handleLogout} style={{ flex: 1, padding: "13px", borderRadius: "10px", background: "#dc2626", border: "none", color: "#ffffff", fontSize: "14px", fontWeight: 600, cursor: "pointer" }}>Yes, Logout</button>
        </div>
      </div>
    </div>
  );
